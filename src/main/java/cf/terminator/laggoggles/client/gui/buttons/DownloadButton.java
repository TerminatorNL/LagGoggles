...
public class DownloadButton extends GuiButton{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        ...
        drawModalRectWithCustomSizedTexture(xPosition+3,yPosition+3,0,0,14,14,14,14);
        if(hovered){
            ...
            GuiUtils.drawHoveringText(hover, mouseX, mouseY, parent.width, parent.height, -1, mc.fontRendererObj);
